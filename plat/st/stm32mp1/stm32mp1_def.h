...
#define STM32MP_DEBUG_USART_BASE	UART8_BASE
/* UART4 on HSI@64MHz, TX on GPIOG11 Alternate 6 */
/* UART8 on HSI@64MHz, TX on GPIOE1 Alternate 8 */
#define STM32MP_DEBUG_USART_CLK_FRQ	64000000
#define DEBUG_UART_TX_GPIO_BANK_ADDRESS	GPIOE_BASE
#define DEBUG_UART_TX_GPIO_BANK_CLK_REG	RCC_MP_AHB4ENSETR
#define DEBUG_UART_TX_GPIO_BANK_CLK_EN	RCC_MP_AHB4ENSETR_GPIOEEN
#define DEBUG_UART_TX_GPIO_PORT		1
#define DEBUG_UART_TX_GPIO_ALTERNATE	8
#define DEBUG_UART_TX_CLKSRC_REG	RCC_UART78CKSELR
#define DEBUG_UART_TX_CLKSRC		RCC_UART78CKSELR_HSI
#define DEBUG_UART_TX_EN_REG		RCC_MP_APB1ENSETR
#define DEBUG_UART_TX_EN		RCC_MP_APB1ENSETR_UART8EN
